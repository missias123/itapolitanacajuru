...
(function(window, document) {
    ...
    var SABORES = ["Abacaxi ao Vinho", "Amarena (Cereja Italiana Azeda)", "Chocolate", "Ferrero Rocher", "Leite Ninho", "Morango Trufado", "Nutella", "Pistache", "Sensação (morango x choc.)", "Torta de Chocolate"];
    var PRODUTOS = [
