...
| **Cardápio & Sabores** | O botão de 35 sabores exigia sincronização de escopo e tratamento de Modo Foco. | Exibição inline rápida, sem saltos ao topo (`_semPulo`), mantendo a posição exata do usuário. | Estrutura validada; os 35 sabores artesanais carregam sob demanda nos produtos elegíveis, mantendo picolés e açaí separados. |
...
2. **Teste Funcional de Encomendas**:
   ...
   - O botão *Escolher sabores* abre o painel com os 35 sabores artesanais, o contador de seleção, o botão de voltar e o botão de confirmação funcionando sem travamentos.
