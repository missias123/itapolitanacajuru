    ...
    try {
      ...
      if (resposta.status === 201 && dados.success) {
        ...
        var msgSucesso = `
          ...
          <div style="font-size: 0.9rem; margin-bottom: 12px; color: #333;">Seu cadastro está registrado para concorrer aos sorteios mensais de 2027 de uma Torta de Sorvete. As inscrições de 2026 foram encerradas com mais de 1.400 inscritos.</div>
