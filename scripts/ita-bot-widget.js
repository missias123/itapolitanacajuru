...
(function () {
  ...
  function _itabotInjetarCss() {
    ...
    style.textContent = [
      ...
      '.itabot-launcher-image { position:absolute; inset:0 auto auto 0; display:block; width:100%; height:auto; max-width:none; object-fit:contain; object-position:top center; clip-path:inset(0 0 18% 0); user-select:none; -webkit-user-drag:none; pointer-events:none; }',
      ...
      '@media (prefers-reduced-motion:reduce) { #itabot-launcher, .itabot-launcher-robot, .itabot-face-led-track, .itabot-launcher-label, .sabor-novo-badge { animation:none; transition:none; } }',
      '@media (max-width:600px) { #itabot-launcher, #itabot-launcher.itabot-launcher-icon-only { right:calc(10px + env(safe-area-inset-right, 0px)); bottom:calc(96px + env(safe-area-inset-bottom, 0px)); width:82px; height:116px; max-width:calc(100vw - 20px); } .itabot-launcher-robot { flex-basis:74px; width:70px; height:74px; } .itabot-launcher-label { min-width:58px; min-height:21px; font-size:9px; padding:3px 8px; } .itabot-face-led-track { font-size:5.5px; } }',
