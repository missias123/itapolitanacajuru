...
(function () {
  ...
  function _itabotInjetarCss() {
    ...
    style.textContent = [
      ...
      '@media (max-width:600px) { #itabot-launcher, #itabot-launcher.itabot-launcher-icon-only { right:calc(10px + env(safe-area-inset-right, 0px)); bottom:calc(96px + env(safe-area-inset-bottom, 0px)); width:82px; height:116px; max-width:calc(100vw - 20px); } .itabot-launcher-robot { flex-basis:74px; width:70px; height:74px; } .itabot-launcher-led-panel { min-width:76px; height:25px; margin-top:1px; padding:0 5px; } .itabot-launcher-led-track { font-size:7px; line-height:21px; } .itabot-face-led-track { font-size:5.5px; } }',
