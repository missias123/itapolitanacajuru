...
<div style="background:linear-gradient(135deg,#0060B0,#0292EC);color:#fff;text-align:center;padding:10px 12px;border-top:3px solid #FBD100;flex-shrink:0;">
  ...
  var RESPOSTAS = {
    ...
    'caça':          '⭐ Caça à Estrela: o Itamanduá aparece em horários surpresa! Quem clicar primeiro captura a estrela. Acumule 5 estrelas no mês e ganhe um prêmio!',
    'estrela':       '⭐ Caça à Estrela: acumule 5 estrelas no mês para ganhar Açaí 400ml, Milkshake ou 5 Picolés Recheados!',
    'itamandua':     '🦎 O Itamanduá é nosso mascote! Ele aparece correndo pelo site em horários surpresa. Clique nele para capturar a estrela!',
    'mascote':       '🦎 Nosso mascote é o Itamanduá! Fique de olho — ele aparece em horários surpresa no site.',
