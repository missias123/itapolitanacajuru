...
(function () {
  ...
  function _itabotInjetarCss() {
    ...
    style.textContent = [
      ...
      '@media (max-width:600px) { #itabot-launcher, #itabot-launcher.itabot-launcher-icon-only { right:calc(10px + env(safe-area-inset-right, 0px)); bottom:calc(96px + env(safe-area-inset-bottom, 0px)); width:164px; height:232px; max-width:calc(100vw - 20px); } .itabot-launcher-robot { flex-basis:148px; width:140px; height:148px; } .itabot-launcher-led-panel { min-width:152px; height:50px; margin-top:1px; padding:0 5px; } .itabot-launcher-led-track { font-size:14px; line-height:42px; } .itabot-face-led-track { font-size:11px; } }',
