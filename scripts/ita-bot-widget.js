...
(function () {
  ...
  function _itabotInjetarCss() {
    ...
    style.textContent = [
      ...
      '.itabot-face-led { position:absolute; left:24%; top:10.5%; width:52%; height:27%; display:flex; align-items:center; overflow:hidden; border:1.5px solid rgba(255,255,255,.8); border-radius:28% / 30%; background:#D51F2A; box-shadow:inset 0 0 6px rgba(0,0,0,.5),0 0 10px rgba(213,31,42,.7); opacity:0; transform:scale(.92); transition:opacity .45s ease,transform .45s ease; pointer-events:none; z-index:2; }',
      ...
      '.itabot-face-led-track { display:inline-block; flex:0 0 auto; min-width:max-content; padding-left:100%; color:#FFCDD2; font:900 6.5px/1 Arial,sans-serif; letter-spacing:.4px; text-shadow:-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000, 0 0 4px #000; white-space:nowrap; animation:itabot-led-marquee 7.4s linear infinite; }',
