...
(function () {
  ...
  function _itabotInjetarCss() {
    ...
    style.textContent = [
      ...
      '.itabot-chest-badge { position:absolute; left:50%; top:58%; width:28%; aspect-ratio:1/1; transform:translate(-50%,-50%); display:flex; align-items:center; justify-content:center; border-radius:50%; border:2px solid rgba(176,234,255,.96); background:radial-gradient(circle at 30% 30%, #7fe8ff 0%, #1ca3ff 42%, #0b4dff 100%); box-shadow:0 0 0 1px rgba(255,255,255,.32), 0 0 12px rgba(0,178,255,.95), 0 0 26px rgba(32,125,255,.75), inset 0 0 10px rgba(255,255,255,.45); color:#fff; font:900 clamp(6px, 1.5vw, 10px)/1 Arial,sans-serif; letter-spacing:.08em; text-shadow:0 1px 3px rgba(0,0,0,.65), 0 0 8px rgba(120,233,255,.92); z-index:3; pointer-events:none; }',
      ...
      '.itabot-launcher-led-panel { position:relative; display:flex; align-items:center; width:100%; min-width:82px; height:26px; margin-top:1px; padding:0 7px; border:2px solid #FF6B73; border-radius:5px; background:#E8000D; box-shadow:0 0 0 1px rgba(255,255,255,.96),0 0 12px rgba(232,0,13,.88),inset 0 0 8px rgba(70,0,0,.62); overflow:hidden; pointer-events:none; user-select:none; }',
      ...
      '.itabot-launcher-led-track { position:relative; z-index:1; display:block; flex:0 0 auto; min-width:max-content; padding-left:100%; color:#FFFFFF; font:900 8px/22px Arial,sans-serif; letter-spacing:.035em; text-shadow:-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000,1px 1px 0 #000,0 0 5px #000; white-space:nowrap; animation:itabot-launcher-led-scroll 6.2s linear infinite; }',
      ...
      '@media (max-width:600px) { #itabot-launcher, #itabot-launcher.itabot-launcher-icon-only { right:calc(10px + env(safe-area-inset-right, 0px)); bottom:calc(96px + env(safe-area-inset-bottom, 0px)); width:82px; height:116px; max-width:calc(100vw - 20px); } .itabot-launcher-robot { flex-basis:74px; width:70px; height:74px; } .itabot-chest-badge { width:30%; border-width:1.5px; font-size:7px; } .itabot-launcher-led-panel { min-width:76px; height:25px; margin-top:1px; padding:0 5px; } .itabot-launcher-led-track { font-size:7px; line-height:21px; } .itabot-face-led-track { font-size:5.5px; } }',
        ...
        '<div class="chat-box itabot-fullscreen-box" role="dialog" aria-modal="true" aria-labelledby="fale-modal-titulo">',
          ...
          '<div id="fale-tela-temas" class="itabot-fullscreen-scroll" style="overflow-y:auto;flex:1;padding:16px;background:#f9f9f9;">',
            ...
            '<div class="itabot-direct-message" style="margin:24px auto;max-width:600px;background:#fff;border-radius:16px;padding:16px;box-shadow:0 2px 12px rgba(0,0,0,.06);">',
              ...
              '<div style="background:#FFF8E1;border:2px solid #FFD600;border-radius:10px;padding:10px 12px;margin-bottom:12px;display:flex;align-items:flex-start;gap:8px;">',
                '<span style="font-size:20px;line-height:1.2;flex-shrink:0;">🍦</span>',
                '<div style="font-size:13px;color:#5D4037;line-height:1.5;">',
                  '<strong style="font-size:13px;color:#E65100;display:block;margin-bottom:2px;">PICOLÉ GRÁTIS É EM OUTRO FORMULÁRIO!</strong>',
                  'Para resgatar o picolé grátis, <strong>feche este painel</strong> e clique no robô quando o LED mostrar <strong>"🍦 PICOLÉ GRÁTIS"</strong>. O formulário de picolé abrirá automaticamente.',
                '</div>',
              '</div>',
